...
class TACSMeshLoader {
 public:
  ...
  void getAssemblerCreatorData(const int vars_per_node, int &my_num_nodes, int &my_num_elements,
                                 ...
                                 OrderingType order_type = NATURAL_ORDER, MatrixOrderingType mat_type = DIRECT_SCHUR);
...
*/
void TACSMeshLoader::getAssemblerCreatorData(const int vars_per_node, int &my_num_nodes, int &my_num_elements,
                                 int &my_num_bcs, int &my_num_components, int *&my_elem_conn,
                                 int *&my_bcs, int *&my_elem_components, TacsScalar *&my_xpts, 
                                 OrderingType order_type, MatrixOrderingType mat_type) {
