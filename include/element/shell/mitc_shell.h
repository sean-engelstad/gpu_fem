...
class MITCShellElementGroup : public BaseElementGroup<MITCShellElementGroup<T, Director_, Basis_, Phys_>, T,
   ...
   public:
    ...
    using Phys = Phys_;
    using ElemGroup = MITCShellElementGroup<T, Director_, Basis_, Phys_>;
