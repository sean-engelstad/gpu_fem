...
// TODO : need to debug this before I compile with it..
// int _gpu_CG(cublasHandle_t cublasHandle, cusparseHandle_t cusparseHandle, int
// m,
...
//         cusparseHandle, CUSPARSE_OPERATION_NON_TRANSPOSE, &one, matL,
...
//         double denominator;
//         CHECK_CUBLAS(
//             cublasDdot(cublasHandle, m, d_T.ptr, 1, d_P.ptr, 1,
//             &denominator))
...
//         CHECK_CUBLAS(
//             cublasDaxpy(cublasHandle, m, &minus_alpha, d_T.ptr, 1, d_R.ptr,
//             1))
//         //----------------------------------------------------------------------
...
//         CHECK_CUSPARSE(cusparseSpSV_solve(
//             cusparseHandle, CUSPARSE_OPERATION_TRANSPOSE, &one, matL,
...
//         double delta_new;
//         CHECK_CUBLAS(
//             cublasDdot(cublasHandle, m, d_R.ptr, 1, d_R_aux.ptr, 1,
//             &delta_new))
...
//     void *buffer;
//     size_t bufferSize;
//     CHECK_CUSPARSE(cusparseSbsrilu02_bufferSize(
//         cusparseHandle, CUSPARSE_DIRECTION_ROW, mb, nnzb, descr, d_bsrValues,
//         d_bsrRowPtr, d_bsrColIdx, blockDim, iluInfo, &bufferSize));
//     CHECK_CUDA(cudaMalloc(&buffer, bufferSize));

//     // Analyze and compute ILU
//     CHECK_CUSPARSE(cusparseSbsrilu02_analysis(
//         cusparseHandle, CUSPARSE_DIRECTION_ROW, mb, nnzb, descr, d_bsrValues,
//         d_bsrRowPtr, d_bsrColIdx, blockDim, iluInfo, policy, buffer));

//     CHECK_CUSPARSE(cusparseSbsrilu02(
//         cusparseHandle, CUSPARSE_DIRECTION_ROW, mb, nnzb, descr, d_bsrValues,
//         d_bsrRowPtr, d_bsrColIdx, blockDim, iluInfo, policy, buffer));

//     // resources,
//     //
//     https://docs.nvidia.com/cuda/cuda-samples/index.html#cusolversp-linear-solver-%5B/url%5D
...
//     printf("CG loop:\n");
//     _gpu_CG(cublasHandle, cusparseHandle, m, matA, matL, d_B, d_X, d_R,
//     d_R_aux,
//             d_P, d_T, d_tmp, d_bufferMV, maxIterations, tolerance);
...
//     CHECK_CUDA(cudaFree(d_bsrColIdx));
//     CHECK_CUDA(cudaFree(d_bsrValues));
