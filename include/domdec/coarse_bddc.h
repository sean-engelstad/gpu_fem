...
template <typename T, class ShellAssembler_, class FineBddcSolver, template <typename> class Vec_,
          template <typename> class Mat_>
class CoarseBddcSolver : public BaseSolver {
    // adapted from BDDC
   ...
   public:
    ...
    BddcSolver(cublasHandle_t &cublasHandle_, cusparseHandle_t &cusparseHandle_,
               FineBddcSolver &fine_bddc_, BsrMatType &kmat_, bool print_timing_ = false,
               bool warnings_ = true)
