...
int main(void)
{
    ...
    // make a dense 10x10 linear system A x = b
    // but stored in the BSR format with block_dim = 1

    // construct the preconditioner to A

    // GMRES should finish in one iteration
