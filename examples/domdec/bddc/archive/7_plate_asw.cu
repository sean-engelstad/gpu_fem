...
int main(int argc, char **argv) {
    ...
    // using SpaiSolver = SPAI<T, Assembler>;
    using ASWSolver = UnstructuredQuadElementAdditiveSchwarzSmoother<T, Assembler>;
    ...
    auto ie_solver = new ASWSolver(cublasHandle, cusparseHandle, assembler, *bddc->kmat_IE, omega, nsmooth);
    auto i_solver = new ASWSolver(cublasHandle, cusparseHandle, assembler, *bddc->kmat_I, omega, nsmooth);
    // auto v_solver = new ASWSolver(cublasHandle, cusparseHandle, assembler, *bddc->S_VV, omega, nsmooth);
    auto *v_solver  = new InnerSolver(cublasHandle, cusparseHandle, assembler, *bddc->S_VV);
