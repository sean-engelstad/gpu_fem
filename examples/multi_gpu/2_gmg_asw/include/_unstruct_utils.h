...
void init_unstructured_grid_maps(const T *h_xpts_fine, const T *h_xpts_coarse,
                                 const int nnodes_fine, const int nnodes_coarse,
                                 const int *h_fine_conn, const int *h_coarse_conn,
                                 const int num_fine_elems, const int num_coarse_elems,
                                 const int *h_fine_elem_comps, const int *h_coarse_elem_comps,
                                 int *&d_n2e_ptr, int *&d_n2e_elems, T *&d_n2e_xis,
                                 BsrData &P_bsr_data, BsrData &PT_bsr_data, DeviceVec<T> &d_P_vals,
                                 DeviceVec<T> &d_PT_vals, const int ELEM_MAX = 10) {
