...
from bsr_aggregation import greedy_serial_aggregation_bsr, tentative_prolongator_bsr, smooth_prolongator_bsr_iterative
...
parser.add_argument("--debug", action=argparse.BooleanOptionalAction, default=True, help="whether to debug multilevel process")
...
if args.debug:
    ...
    # Bc = Bc.reshape((Bc.shape[0] * 6, 6))

    P = smooth_prolongator_bsr_iterative(T, A, B, Bc, bc_flags, omega=omega, 
                               near_kernel=not(args.nokernel), niter=args.nmatrix)
    Bc *= -1 # DEBUG
