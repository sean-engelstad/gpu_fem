...
class Nonlinear_GMGASW_PlateSolver {
   public:
    using T = double;
    // FEM typedefs
    ...
    Nonlinear_GMGASW_PlateSolver(double rhoKS = 100.0, double safety_factor = 1.5,
                                 double load_mag = 100.0, T omega = 1.0, int nxe = 100,
                                 int nx_comp = 5, int ny_comp = 5, double SR = 50.0, int ORDER = 8,
